...
const createTimeOffSchema = z.object({
  ...
  leave_type: z.enum(['CASUAL', 'SICK', 'EARNED', 'MATERNITY', 'PATERNITY', 'UNPAID', 'COMP_OFF']),
...
const timeOffQuerySchema = z.object({
  ...
  leave_type: z.enum(['CASUAL', 'SICK', 'EARNED', 'MATERNITY', 'PATERNITY', 'UNPAID', 'COMP_OFF']).optional(),
