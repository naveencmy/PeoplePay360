...
// Structures
router.get('/', authorize('ADMIN', 'HR', 'AUDITOR'), ctrl.listStructures);
router.get('/:id', authorize('ADMIN', 'HR', 'AUDITOR'), validate({ params: structureIdParamSchema }), ctrl.getStructure);
...
router.get('/:id/rules', authorize('ADMIN', 'HR', 'AUDITOR'), validate({ params: structureIdParamSchema }), ctrl.getRules);
