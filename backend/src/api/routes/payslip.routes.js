...
router.post('/:id/email', authorize('ADMIN', 'HR'), validate({ params: payslipIdParamSchema }), ctrl.emailPayslip);

// Batch operations (by payrun)
router.get('/payrun/:payrunId', authorize('ADMIN', 'HR', 'MANAGER', 'AUDITOR'), ctrl.getPayslipsByPayrun);
